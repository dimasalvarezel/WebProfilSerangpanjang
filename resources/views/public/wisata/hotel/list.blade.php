            ...
            <div class="list-group">
              <li class="list-group-item list-group-item-action d-flex justify-content align-items-start">
                <div class="list-content col-md-4 col-sm-4">
                  <img src="{{asset('assets/img/cijalu_resort.png')}}" class="img-fluid">
                </div>
                <div class="ms-2 me-auto">
                  <div class="d-flex w-100 justify-content">
                    <h5 class="mb-1"><a href="http://cijaluresorts.com/" target="_blank" style="text-decoration:none;color:black;">Cijalu Resort</a></h5>
                  </div>
                  <p class="mb-1">
                    Alamat : Jl. Curug Cijalu, Cipancar, Serangpanjang, Kabupaten Subang, Jawa Barat 41282<br>
                    Kontak : +6282172720066
                  </p>
                  <div class="btn-group-vertical" role="group" aria-label="Basic example">
                    <p class="mb-1"><a href="https://www.google.com/travel/hotels/s/gPNmM" target="_blank">Lihat Ulasan Google</a></p>
                    <p class="mb-1"><a href="https://www.traveloka.com/id-id/hotel/indonesia/cijalu-resort-3000020005905" target="_blank">Lihat di Traveloka</a></p>
                    <p class="mb-1"><a href="https://g.page/cijalu-resort?share" target="_blank">Lihat di Google Maps</a></p>
                  </div>
                </div>
              </li>
            </div>
