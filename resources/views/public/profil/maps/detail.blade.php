...
@section('meta')
  <meta name="description" content="{{htmlspecialchars($maps->description)}}" />
  ...
  <meta property="og:image" content="{{($maps->thumbnail)?asset('/storage/video/thumbs/'.$maps->thumbnail):asset('fontend/images/grid/1.jpg')}}"/>
@endsection
