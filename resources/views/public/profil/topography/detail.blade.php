...
@section('meta')
  <meta name="description" content="{{htmlspecialchars($topography->description)}}" />
  ...
  <meta property="og:image" content="{{($topography->thumbnail)?asset('/storage/video/thumbs/'.$topography->thumbnail):asset('fontend/images/grid/1.jpg')}}"/>
@endsection
