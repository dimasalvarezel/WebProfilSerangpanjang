...
@section('meta')
  <meta name="description" content="{{htmlspecialchars($visi->description)}}" />
  ...
  <meta property="og:image" content="{{($visi->thumbnail)?asset('/storage/video/thumbs/'.$visi->thumbnail):asset('fontend/images/grid/1.jpg')}}"/>
@endsection
