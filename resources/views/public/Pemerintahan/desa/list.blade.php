            ...
            <div class="list-group">
              <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-start">
                <div class="list-content col-md-4 col-sm-4">
                  <img src="https://3.bp.blogspot.com/-f905CE-krao/WXAhpwKHaMI/AAAAAAAAdzY/f3nOWjnn3-YgeeRHSYIRls5Et56Hmj4MgCLcBGAs/w1280-h720-p-k-no-nu/a-Kantor%2BDesa%2BCijengkol%2BSerangpanjang%2B-%2BMANGYONOcom.jpg" class="img-fluid">
                </div>
